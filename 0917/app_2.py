...
def main():
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            img_arm_r = Image.open('./static/0913/arm_r.png')
            img_arm_l = Image.open('./static/0913/arm_l.png')

            img_hand_r = Image.open('./static/0913/hand_r.png')
            img_hand_l = Image.open('./static/0913/hand_l.png')
            ...
            for d_p in data_p:
                ...
                img_hand_l_re = img_hand_l.resize((100,600))
                # img_hand_r_re = img_hand_r.resize((r_hand_w,r_hand_h+20))
                img_hand_r_re = img_hand_r.resize((100,600))

                # img_arm_l_re = img_arm_l.resize((l_arm_w,l_arm_h))
                img_arm_l_re = img_arm_l.resize((100,600))
                # img_arm_r_re = img_arm_r.resize((r_arm_w,r_arm_h))
                img_arm_r_re = img_arm_r.resize((100,600))
                ...
                if d_p['l_hip'][1] > d_p['l_knee'][1]:
                    ...
                    img_leg_l_re_rotate = img_leg_l_re.rotate(-15)
